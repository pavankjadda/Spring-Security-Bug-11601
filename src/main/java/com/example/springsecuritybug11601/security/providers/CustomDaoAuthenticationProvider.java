package com.example.springsecuritybug11601.security.providers;
...
/**
 * Custom authentication provider that implements JDBC authentication and stores username and password in database(encrypted)
 *
...
public class CustomDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    private PresDbUserDetailsService presDbUserDetailsService;
    ...
    protected void doAfterPropertiesSet() {
        Assert.notNull(presDbUserDetailsService, "A UserDetailsService must be set");
    }

    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
        prepareTimingAttackProtection();
        try {
            UserDetails loadedUser = presDbUserDetailsService.loadUserByUsername(username);
            if (loadedUser == null) {
     ...
     *
     * @param authentication Username and Password Authentication Token
     */
    ...
    public void setUserDetailsService(PresDbUserDetailsService userDetailsService) {
        this.presDbUserDetailsService = userDetailsService;
    }
}
